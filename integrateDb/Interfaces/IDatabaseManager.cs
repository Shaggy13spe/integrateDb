...
namespace integrateDb.Interfaces
{
  public interface IDatabaseManager
  {
    ...
    IDatabaseManager RegisterFormatter(string tableName, string column, Func<object, string> func);
    IDatabaseManager RegisterFormatter(string tableName, string column, IColumnFormatter formatter);
